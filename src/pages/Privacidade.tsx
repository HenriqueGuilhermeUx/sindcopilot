    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <article className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
          ...
          <section><h2>2. Escopo desta política</h2><p>Esta política explica quais dados são tratados quando você cria uma conta, usa o painel ou o aplicativo, cadastra condomínios, envia documentos, registra visitas ou ocorrências, anexa evidências, utiliza recursos de inteligência artificial, contrata um plano ou entra em contato com o suporte.</p></section>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Fotos, vídeos e arquivos:</strong> acessados quando o usuário escolhe anexar uma evidência ou documento.</li>
